...
const REQUIRED_FIELDS = [
  ...
  { key: 'origem', label: 'Origem', type: 'select', canBeEmpty: false, options: ['Indicação', 'Orgânico', 'Tráfego Pago', 'Evento', 'Cold Call', 'WhatsApp', 'Instagram', 'Facebook', 'Google', 'LinkedIn', 'Outro'] },
];
